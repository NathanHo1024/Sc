...
public class DeptController {
    ...
    @HystrixCommand(fallbackMethod = "processHystrix_Get")//调用方法失败并抛出错误信息，会自动调用@HystrixCommand备注好的fallbackMethod 声明的方法。
    ...
    public ReturnResult processHystrix_Get(@PathVariable Integer id){

        return new ReturnResult().setCode(300).setMsg("无此ID的信息:" + id + ",null———@HystrixCommand");
    }
